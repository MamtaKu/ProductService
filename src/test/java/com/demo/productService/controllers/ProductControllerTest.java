...
//    @Test
//    public void testGetSingleProductPositive() throws ProductNotFoundException, InvalidTokenException, UnauthorizedAccessException {
//        //Arrange
//        Long productId = 9L;
...
//
//        //Act
//        ResponseEntity<Product> response = productController.getSingleProduct(productId, token);
//
//        //Assert
//        assertEquals(expectedOutput, response.getBody(), "Products are not same");
//
//    }
//
//    @Test
...
//
//        assertThrows(ProductNotFoundException.class, () -> productController.getSingleProduct(productId, token));
//    }
//
//    @Test
...
//                () -> productController.getSingleProduct(productId, token));
//
